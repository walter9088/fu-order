...
//    String MINUS_MONEY = "update account set money = money-#{1} where id = #{0}";
    ...
    //String INSERT_TEST = "insert into test (username,password) values (#{username},#{password})";

    String INSERT_TEST = "insert into test (username,password) values (#{0},#{1})";
...
//            " id >= #{id}";
    ...
    @Insert(INSERT_TEST)
    public int insertTest(String username, String password);
